                    ...
                    <div className="max-w-5xl mx-auto space-y-6">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <Card className="border shadow-sm">
                                <CardHeader className="border-b bg-white pb-4">
                                    <div className="flex items-center gap-3 text-blue-600 mb-1">
                                        ...
                                        <CardTitle className="text-lg text-foreground">Diseño del Ticket</CardTitle>
                                    </div>
                                    <CardDescription>
                                ...
                                <CardContent className="pt-6 space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <div className="flex items-center justify-between p-4 border rounded-lg bg-white">
                                            <div className="space-y-0.5">
                                                <Label htmlFor="show_logo" className="text-base">Mostrar Logo</Label>
                                                <p className="text-xs text-muted-foreground">Incluir logo del negocio</p>
                                            </div>
                                            <Switch
                                                id="show_logo"
                                        ...
                                        <div className="flex items-center justify-between p-4 border rounded-lg bg-white">
                                            <div className="space-y-0.5">
                                                <Label htmlFor="show_business_info" className="text-base">Datos del Negocio</Label>
                                                <p className="text-xs text-muted-foreground">Nombre, dirección, CUIT</p>
                                            </div>
                                            <Switch
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Select
                                            ...
                                            onValueChange={(value) =>
                                                setFormData({ ...formData, paper_size: value })
                                            }
                                        >
                                            <SelectTrigger id="paper_size" className="bg-gray-50/50">
                                    ...
                                    <div className="grid grid-cols-1 gap-4">
                                        <div className="space-y-2">
                                            <Label htmlFor="header_message">Mensaje de Encabezado</Label>
                                            <Textarea
                                                id="header_message"
                                                value={formData.header_message || ""}
                                                onChange={(e) =>
                                                    setFormData({ ...formData, header_message: e.target.value })
                                                }
                            ...
                            <Card className="border shadow-sm">
                                <CardHeader className="border-b bg-white pb-4">
                                    <div className="flex items-center gap-3 text-purple-600 mb-1">
                                        ...
                                        <CardTitle className="text-lg text-foreground">Hardware</CardTitle>
                                    </div>
                                    <CardDescription>
                                        Define los parámetros técnicos de la impresora
                                    </CardDescription>
                                </CardHeader>
                                <CardContent className="pt-6 space-y-4">
                                    <div className="space-y-2">
                                        <Label htmlFor="printer_name">Nombre de la Impresora *</Label>
                                        <Input
                                            id="printer_name"
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div className="space-y-2">
                                            <Label htmlFor="printer_type">Tipo de Impresora *</Label>
                                            <Select
                                                value={formData.printer_type}
                                                onValueChange={(value) =>
                                                    setFormData({ ...formData, printer_type: value })
                                                }
                                            >
                                                <SelectTrigger id="printer_type" className="bg-gray-50/50">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <Input
                                                ...
                                                onChange={(e) =>
                                                    setFormData({ ...formData, paper_width: parseInt(e.target.value) })
                                                }
                                                className="bg-gray-50/50"
                                            />
                                        </div>
                                    ...
                                    <div className="flex items-center justify-between p-4 border rounded-lg bg-white mt-2">
                                        <div className="space-y-0.5">
                                            <Label htmlFor="auto_print" className="text-base">Impresión Automática</Label>
                                            <p className="text-xs text-muted-foreground">Imprimir automáticamente al generar ticket</p>
                                        </div>
                                        <Switch
                                            id="auto_print"
                            ...
                            <div className="flex justify-end pt-4">
                                <Button type="submit" size="lg" className="bg-blue-600 hover:bg-blue-700 text-white shadow-md gap-2">
